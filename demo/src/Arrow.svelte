...
{#if direction === 'up'}
  <svg
    ...
    stroke-miterlimit="2">
    <path
      d="M284.582 464.344l-.168.768V135.888l103.724 103.496c5.064 5.068 11.924
      ...
      27.288h22.788c14.82 0 26.6-12.828 26.6-27.656z"
      fill-rule="nonzero" />
  </svg>
{:else}
  <svg
    ...
    stroke-miterlimit="2">
    <path
      d="M207.418 27.656l.168-.768v329.224L103.862
